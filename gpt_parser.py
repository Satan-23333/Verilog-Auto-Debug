...
class gptParser:
    ...
    def regenerate_answer(self) -> None:
        ...
        """
        self.driver.find_elements(By.CLASS_NAME, "flex items-center gap-1.5 text-xs").click()
        sleep(random.uniform(1, 5))
        self.driver.find_elements(By.CLASS_NAME, "btn relative btn-primary mr-2").click()
